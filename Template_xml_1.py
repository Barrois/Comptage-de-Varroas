...
threshold = 0.992
# read  image
filename = 'Michel1530_3' # CM_Cal_10V_A4 Michel1530_4 CM_Cal_22V_A4
...
#'crop_89.jpg'
a2,retour_2,cmpt = detect_crop('crop_200.jpg',retour_1,0,0,255,cmpt)

#'crop_22.jpg'
a3,retour_3,cmpt = detect_crop('crop_202.jpg',retour_2,255,0,255,cmpt)

#'crop_59jpg'
a4,retour_4,cmpt = detect_crop('crop_204.jpg',retour_3,255,255,0,cmpt)

#'crop_59jpg'
a5,retour_5,cmpt = detect_crop('crop_22.jpg',retour_4,100,255,100,cmpt)

# décompte avec suppression des doublons 
listOfTuple = (a0+a1+a2+a3+a4+a5)
uniqueList = count(listOfTuple) 



# sauvegarde de la dernière image
cv2.imwrite('resultat_Template_xml.jpg', retour_5)
