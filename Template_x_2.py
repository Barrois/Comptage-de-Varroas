...
def detect_crop (filecrop,image_avant,couleur1,couleur2,couleur3) :
...
threshold = 0.992
# read  image
filename = 'Michel1530_4.JPG'
# img = cv2.imread('Michel1530_3.JPG') # Michel1530_3.jpg CM_10v_1.JPG
img = cv2.imread(filename)

#'crop_3.jpg'
a0,retour_0 = detect_crop('crop_3.jpg',img,0,255,0) 

# 'crop_25.jpg'
a1,retour_1 = detect_crop('crop_25.jpg',retour_0,255,0,0)

#'crop_89.jpg'
a2,retour_2 = detect_crop('crop_89.jpg',retour_1,0,0,255)

#'crop_22.jpg'
a3,retour_3 = detect_crop('crop_22.jpg',retour_2,255,0,255)

#'crop_59jpg'
a4,retour_4 = detect_crop('crop_59.jpg',retour_3,255,255,0)
...
cv2.imwrite('resultat_Template_x.jpg', retour_4)
